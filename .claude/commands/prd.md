---
description: "Generate a Product Requirements Document (PRD) for a new feature, enhancement, or optimization"
argument-hint: "<feature description>"
---

# PRD Generator

Create a detailed Product Requirements Document that is clear, actionable, and suitable for implementation.
...
1. Receive the feature description above (from user's arguments).
2. Ask 3-5 essential clarifying questions (with lettered options) using the AskUserQuestion tool.
3. Keep interviewing continually until requirements are completed and clear.
...
- [ ] Used AskUserQuestion tool for interactive clarification
